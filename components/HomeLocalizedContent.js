...
const content = {
  ...
  ps: {
    subtitle:
      "په هامبورګ کې عامه ګټې ټولنیز او کلتوري کار — د لیدنې، ادغام او په ورځني ژوند کې ملاتړ لپاره.",
    intro:
      "موږ د مختلفې اصل او کلتور خلکو ترمنځ لیدنه او ټولنیز ګډون پیاوړی کوو. د دې لپاره موږ ټولنیز او تعلیمي خدمتونه او د اړمنو کسانو او کورنیو لپاره ملاتړ وړاندې کوو.",
    ctaJoin: "ګډون وکړئ",
    ...
    aboutText1: (
      <>
        ...
        په هامبورګ کې یو عامه ګټې بنسټ دی. موږ د زغم، متقابل پوهې او عملي
        مرستې لپاره کار کوو — د غونډو، د لیدنې فرصتونو او په ورځني ژوند کې
        ملاتړ له لارې.
      </>
    ),
    aboutText2:
      "موږ له ګوندي سیاست څخه بې‌ګوندي او له دیني تعصب څخه ازاد یو. زموږ کار په روڼتیا، باور او د درناوي چاپیریال کې ترسره کېږي.",
    joinTitle: "ګډون",
    joinText:
